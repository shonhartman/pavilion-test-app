...
class IndexView extends React.Component {
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '6362d73c42adb7015ff6609c'
          ...
          <div>
            <div data-collapse="medium" data-animation="default" data-duration={400} data-easing="ease" data-easing2="ease" role="banner" className="af-class-navigation-bar w-nav">
              <div className="w-container">
                <a href="index.html" aria-current="page" className="af-class-brand-link w-nav-brand w--current">
                  <h1 className="af-class-brand-text">NEWPORT</h1>
                </a>
                <nav role="navigation" className="af-class-navigation-menu w-nav-menu">
                  <a href="index.html" aria-current="page" className="af-class-navigation-link w-nav-link w--current">Gallery</a>
            ...
            <div className="w-container">
              <div className="w-form">
                <form id="email-form" name="email-form" data-name="Email Form" method="get"><label htmlFor="name">Search the Marketplace</label><input type="text" className="w-input" maxLength={256} name="name" data-name="Name" placeholder id="name" /><input type="submit" defaultValue="Submit" data-wait="Please wait..." className="w-button" /></form>
